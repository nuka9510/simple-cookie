...
class Cookie {
    ...
    toString() {
        ...
        return `${this.#name}=${value};${_nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.JUtil.empty(this.#domain) ? '' : ` Domain=${this.#domain};`}${_nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.JUtil.empty(this.#expires) ? '' : ` Expires=${this.#expires.toUTCString()};`}${(this.#httpOnly) ? ' HttpOnly;' : ''}${_nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.JUtil.isNumber(this.#maxAge, true) ? ` Max-Age=${this.#maxAge};` : ''}${(this.#partition) ? ' Partitioned;' : ''}${_nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.JUtil.empty(this.#path) ? '' : ` Path=${this.#path};`}${_nuka9510_js_util__WEBPACK_IMPORTED_MODULE_0__.JUtil.empty(this.#sameSite) ? '' : ` SameSite=${this.#sameSite};`}${(this.#secure) ? ' Secure;' : ''}`;
    }
    /**
     * `cookie` 값 반환
     *
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SCookie: () => (/* reexport safe */ _cookie_mjs__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
