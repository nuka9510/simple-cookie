...
export default class Cookie {
   ...
   * `Domain=domain;`
   */
  get domain(): string { return JUtil.empty(this.#domain) ? '' : `Domain=${ this.#domain };`; }
   ...
   * `Expires=expires;`
   */
  get expires(): string { return JUtil.empty(this.#expires) ? '' : `Expires=${ this.#expires.toUTCString() };`; }
   ...
   * `Max-Age=maxAge;`
   */
  get maxAge(): string { return JUtil.isNumber(this.#maxAge, true) ? `Max-Age=${ this.#maxAge };` : ''; }
   ...
   * `Path=path;`
   */
  get path(): string { return JUtil.empty(this.#path) ? '' : `Path=${ this.#path };`; }
   ...
   * `SameSite=sameSite;`
   */
  get sameSite(): string { return JUtil.empty(this.#sameSite) ? '' : `SameSite=${ this.#sameSite };`; }
